...
const grant_lesson_access_dto_1 = require("./dto/grant-lesson-access.dto");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lấy danh sách học viên được cấp quyền truy cập bài học' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Lesson ID (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lấy danh sách quyền truy cập thành công.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Không tìm thấy bài học.' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LessonsController.prototype, "getAccessList", null);
__decorate([
    (0, common_1.Post)(':id/access'),
    (0, swagger_1.ApiOperation)({ summary: 'Cấp quyền truy cập bài học theo email học viên' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Lesson ID (UUID)' }),
    (0, swagger_1.ApiBody)({
        schema: {
            type: 'object',
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Cấp quyền truy cập thành công.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Không tìm thấy bài học hoặc học viên.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, grant_lesson_access_dto_1.GrantLessonAccessDto]),
    __metadata("design:returntype", void 0)
], LessonsController.prototype, "grantAccessByEmail", null);
__decorate([
    (0, common_1.Delete)(':id/access/:userId'),
    (0, swagger_1.ApiOperation)({ summary: 'Thu hồi quyền truy cập bài học của học viên' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Lesson ID (UUID)' }),
    (0, swagger_1.ApiParam)({ name: 'userId', description: 'Student user ID (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Thu hồi quyền truy cập thành công.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Không tìm thấy bài học.' }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], LessonsController.prototype, "revokeAccess", null);
__decorate([
