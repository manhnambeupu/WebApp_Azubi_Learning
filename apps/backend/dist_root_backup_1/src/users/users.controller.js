...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lấy danh sách học viên' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lấy danh sách học viên thành công.' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Tạo tài khoản học viên' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Tạo học viên thành công.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Xóa học viên' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Student user ID (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Xóa học viên thành công.' }),
...
exports.UsersController = UsersController = __decorate([
    ...
    (0, swagger_1.ApiTags)('Admin — Students'),
